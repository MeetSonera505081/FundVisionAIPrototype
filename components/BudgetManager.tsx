                  ...
                  <div className="flex items-center space-x-2">
                    {editingCategory === budget.category ? (
                      <div className="flex items-center space-x-2" onClick={e => e.stopPropagation()}>
                        <input 
                          type="number" 
                          className="w-24 px-2 py-1 border border-orange-200 rounded text-sm outline-none focus:ring-2 focus:ring-orange-500/20"
                          value={editValue}
                          onChange={(e) => setEditValue(e.target.value)}
                          autoFocus
                        />
                        <button onClick={() => handleSave(budget.category)} className="text-emerald-600 hover:text-emerald-700">
