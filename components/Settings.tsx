      ...
      <div className="bg-white rounded-3xl shadow-sm border border-orange-100 overflow-hidden">
        <div className="p-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            {isEditing ? (
              <div className="space-y-3">
                <input 
                  type="text" 
                  className="block w-full px-3 py-2 border border-orange-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-500/20 outline-none"
                  value={userInfo.name}
          ...
          <button 
            ...
            className="px-6 py-2 border border-orange-200 rounded-xl text-sm font-bold text-orange-600 hover:bg-orange-50 transition-colors"
          >
